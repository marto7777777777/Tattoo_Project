  ...
  return <div id="top" className="artist-landing" data-i18n-ignore>
    ...
    <main>
      ...
      <section className="landing-section landing-shell landing-pricing" id="pricing">
        ...
        <ul><li>{language === "bg" ? "Платежен метод може да бъде изискан при започване на trial периода." : "A payment method may be required when the trial starts."}</li><li>{language === "bg" ? "Няма таксуване през първите 3 месеца от стартирането на абонамента." : "No charge during the first 3 months from the start of the subscription."}</li><li>{language === "bg" ? "След това — автоматично месечно подновяване." : "Automatic monthly renewal after the trial."}</li><li>{language === "bg" ? "Крайната цена и данъците се показват от платежния доставчик преди потвърждение." : "The final price and taxes are shown by your payment provider before confirmation."}</li><li>{language === "bg" ? "Можеш да прекратиш абонамента си по всяко време." : "Cancel your subscription at any time."}</li></ul>
      </section>
