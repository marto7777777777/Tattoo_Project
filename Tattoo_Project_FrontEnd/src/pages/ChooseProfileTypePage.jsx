...
function ChooseProfileTypePage() {
  return (
    <main className="page-shell profile-choice-page">
      <section className="container profile-choice-container">
        <div className="header profile-choice-header"><p className="subtitle">Profile setup</p><h1>How do you want to use the platform?</h1><p>Choose whether you want to create a client profile or a tattoo artist profile.</p></div>
        <div className="grid-2 profile-choice-grid">
