...
function BookingSlotPage() {
  ...
  const bookingType = "consultation";
  const title = "Book consultation";
  const subtitle = "Consultation";
  const actionLabel = "Book consultation";
  ...
  async function handleSubmit(event) {
    ...
    try {
      const payload = { tattooRequestId: Number(requestId), startTime: toApiDateTime(selectedSlot.startTime), notes };
