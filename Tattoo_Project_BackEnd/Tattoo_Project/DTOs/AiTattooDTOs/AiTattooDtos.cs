...
public class AiTattooProjectDto { public int Id {get;set;} public string Title {get;set;}=null!; public string TattooStyle {get;set;}=null!; public string Placement {get;set;}=null!; public string InitialDescription {get;set;}=null!; public bool IsFreeProject {get;set;} public int FreeEditsUsed {get;set;} public int FreeEditsRemaining {get;set;} public DateTime? EditingAccessUntil {get;set;} public bool HasGeneratedInitialVersion {get;set;} public bool CanGenerate {get;set;} public bool CanEdit {get;set;} public bool NeedsPayment {get;set;} public DateTime CreatedAt {get;set;} public List<AiTattooVersionDto> Versions {get;set;}=[]; }
